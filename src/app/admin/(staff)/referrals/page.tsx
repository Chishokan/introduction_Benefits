...
export default async function ReferralListPage({ searchParams }: PageProps<"/admin/referrals">) {
  ...
  const query = (patch: Record<string, string | undefined>) => {
    ...
    return s ? `/admin/referrals?${s}` : "/admin/referrals";
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <form className="card flex flex-wrap items-end gap-3 p-3" action="/admin/referrals">
